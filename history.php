...
$reponse = $bdd->query('SELECT * FROM data ORDER BY id DESC');  //Requette SQL qui dit affiche tout de la base DATA par date d'ajout la plus récente
?>
        ...
        <div class="history_container">
            ...
            <div class="tbl-header">
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <th>Date</th>
                        <th style="padding-left: 10px;">Étages</th>
                        <th style="padding-left: 5px;">Positions</th>
                        <th style="padding-left: 2px;">Prix</th>
                    </tr>
                    </thead>
                </table>
                </div>
